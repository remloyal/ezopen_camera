...
import 'ezopen_camera_method_channel.dart';

abstract class EzopenCameraPlatform extends PlatformInterface {
  /// Constructs a EzopenCameraPlatform.
  EzopenCameraPlatform() : super(token: _token);

  static final Object _token = Object();

  static EzopenCameraPlatform _instance = MethodChannelEzopenCamera();

  /// The default instance of [EzopenCameraPlatform] to use.
  ///
  /// Defaults to [MethodChannelEzopenCamera].
  static EzopenCameraPlatform get instance => _instance;

  /// Platform-specific implementations should set this with their own
  /// platform-specific class that extends [EzopenCameraPlatform] when
  /// they register themselves.
  static set instance(EzopenCameraPlatform instance) {
