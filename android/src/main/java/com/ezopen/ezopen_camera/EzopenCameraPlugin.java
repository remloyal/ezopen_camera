 ...
 * EzopenCameraPlugin
 */
public class EzopenCameraPlugin implements FlutterPlugin, MethodCallHandler {
    /// The MethodChannel that will the communication between Flutter and native Android
    ///
    /// This local reference serves to register the plugin with the Flutter Engine and unregister it
    /// when the Flutter Engine is detached from the Activity
    private static final String TAG = "EZOpenSDK-MethodCallHandler";
    private MethodChannel channel;

    private Application application;

    private EZPlayer ezPlayer = null;
    private  EZOpenViewFactory factory;
    private String deviceSerial;
    private int cameraNo;

    @Override
    public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
        channel = new MethodChannel(binding.getBinaryMessenger(), "ezopen_plugin_sdk");
        factory = new EZOpenViewFactory();
        this.application =(Application) binding.getApplicationContext();

//        channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "ezopen_camera");
    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
        try {
            ...
            } else if ("initLibWithAppKey".equals(method)) {
